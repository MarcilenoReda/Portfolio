...
const ContactSection: React.FC = () => {
  return (
    <section id="contact" className="py-20 bg-[#111] px-4">
            ...
            <form className="space-y-6">
              <div>
                ...
                <input
                  ...
                  id="name"
                  name="name"
                  className="w-full bg-[#333] border-0 rounded-md py-3 px-4 text-gray-100 focus:ring-2 focus:ring-purple-500 focus:outline-none"
